...
**See the included `CHANGELOG.txt` or [here](https://github.com/albar965/littlenavmap/blob/v3.0.4/CHANGELOG.txt) online for a complete list across all versions.**
